...
// Wi-Fi credentials
// ----------------------
const char *ssid = "dlink-8ED8";
const char *password = "j63zvt3j";
...
// ----------------------
const char http_base_url[] = "https://iot-commander-worker.debbal-lotfi-dev.workers.dev";
const char notify_endpoint[] = "/api/subscriptions/send";
const char api_key[] = "lol";
